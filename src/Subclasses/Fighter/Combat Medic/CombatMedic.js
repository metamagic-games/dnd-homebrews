...
var theCoD = AddSubClass("fighter", "brute-giantitp", {
  ...
  features : {
    "subclassfeature3.1" : {
      ...
      source : ["S:Combat Medic",  0],
      minlevel : 3,
      description : "You gain proficiency in one of the following skills of your choice: Medicine, Survival, Insight, Persuasion.",
    },
     "subclassfeature3.2" : {
      name : "Combat Medic's Equipment",
      source : ["S:Combat Medic",  0],
      minlevel : 3,
      description : "You gain a Healer's Kit. This kit is a leather pouch containing bandages, salves, and splints. The kit has up to ten uses. As an action, you can expend one use of the kit to stabilize a creature that has O hit points, without needing to make a Wisdom (Medicine) check.\nYou kit starts with 0 uses. Whenever you make a rest, you can make a survival check to scavenge for more supplies (DC15). If you succeed during a Short Rest, your kit gains 1 use. If you succeed during a Long Rest, your kit gains 1d4 uses.",
    },
     "subclassfeature3.3" : {
      name : "Healer",
      source : ["S:Combat Medic",  0],
      minlevel : 3,
      description : "At 3rd level, you gain the _Healer_ feat. You are an able physician, allowing you to mend wounds quickly and get your allies back in the fight. You gain the following benefits: When you use a healer's kit to stabilize a dying creature, that creature also regains 1 hit point. As an action, you can spend one use of a healer's kit to tend to a creature and restore 1d6 + 4 hit points to it, plus additional hit points equal to the creature's maximum number of Hit Dice. The creature can't regain hit points from feat again until it finishes a short or long rest.",
    },
    "subclassfeature7" : {
    ...
    "subclassfeature18" : {
      ...
      source : ["S:Combat Medic", 0],
      minlevel : 18,
      description : "Once per Short Rest, when attacking a humanoid creature, you can choose to use _Anatomical Precision_. Make a medicine check. If you succeed, you gain advantage on your attack.",
      recovery : "short rest",
      usages : 1,
      action : ["reaction", ""],
    }
