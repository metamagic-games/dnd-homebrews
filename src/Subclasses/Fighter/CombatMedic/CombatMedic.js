...
var theCoD = AddSubClass("fighter", "brute-giantitp", {
  ...
  features: {
    ...
    subclassfeature7: {
      ...
      usages: 1,
      description:
        "If I or a creature I can see within 5 feet of I is hit by an attack, I can roll 1d8 as a reaction if I’re wielding a melee weapon or a shield. Roll the die, and add the number rolled to the target’s AC against that attack. If the attack still hits, the target has resistance against the attack’s damage.\nI can use this feature a number of times equal to my Constitution modifier (minimum of once), and I regain all expended uses of it when I finish a long rest.",
      action: ["reaction", ""],
      spellcastingBonus: {
    ...
    subclassfeature10: {
      ...
      minlevel: 10,
      description: desc([
        "As a bonus action. I can spend one use of a healer's kit to tend to a creature and restore 1d4 + 4 hit points to it, plus additional hit points equal to the creature's maximum number of Hit Dice. The creature can't regain hit points from feat again until it finishes a short or long rest.",
