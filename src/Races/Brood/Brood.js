...
RaceList["leatherwing brood"] = {
  ...
  improvements : "Brood: +2 Charsima and +1 to Strength, Dexterity, or Constitution;",
  scores : [-1, 1, -1, 1, 2, 0],
  trait : "Brood (+2 Wisdom, +1 to Strength and Intelligence, -1 Constitution and Strength)" + (typePF ? " " : "\n") + "From 3rd level, you can use an action to unfurl wings, and gain a fly speed for 1 hour.",
  features : {
    "unfurl wings" : {
      name : "Unfurl Wings",
      minlevel : 3,
