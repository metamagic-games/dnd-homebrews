...
RaceList["pearl"] = {
  ...
  scores: [0, 0, -5, 2, 2, 0],
  trait:
    "Pearl (+2 Intelligence and Wisdom, -5 Constitution)\nPearl Magic: 1st level: Message cantrip; 3rd level: Command at 1st-level, once per short rest; 5th level: Charm Person at 2nd-level, once per long rest. Both spells can be cast without material components. Intelligence is my spellcasting ability for these.\nInvade Mind: As an action, once per 30 days, I can try to invade the mind of any humanoid of intelligence 10 or greater, and of size Medium or less. The target must pass a Wisdom saving throw or be invaded.\nThe host can resist, but I gain full control after three consecutive failures and cannot be resisted. This resets if the Pearl ever voluntarily gives control back to the host.\nI can be targeted by psychic attacks, and all psychic attacks targeting my host hit me instead. If my hit points are reduced to 0, I die without making death saving throws.",
